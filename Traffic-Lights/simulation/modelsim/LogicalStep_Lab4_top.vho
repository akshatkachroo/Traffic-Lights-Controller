...
SIGNAL \INST3|sreg1[0]~feeder_combout\ : std_logic;
...
SIGNAL \INST6|sreg[1]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \INST3|rst_n_filtered~0_combout\ = (!\INST3|sreg4\(2) & (!\INST3|sreg4\(3) & !\INST3|sreg4\(1)))
...
\INST3|sreg1[0]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|sreg1[0]~feeder_combout\ = \pb_n[1]~input_o\
...
PORT MAP (
	...
	combout => \INST3|sreg1[0]~feeder_combout\);
...
PORT MAP (
	clk => \clkin_50~inputclkctrl_outclk\,
	d => \INST3|sreg1[0]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \INST3|sreg1\(0));
...
-- Equation(s):
-- \INST3|pb_n_filtered[1]~2_combout\ = (!\INST3|sreg1\(2) & (!\INST3|sreg1\(3) & !\INST3|sreg1\(1)))
...
\INST6|sreg[1]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|sreg[1]~feeder_combout\ = \INST6|sreg\(0)
...
PORT MAP (
	datad => \INST6|sreg\(0),
	combout => \INST6|sreg[1]~feeder_combout\);
...
-- Equation(s):
-- \INST3|pb_n_filtered[0]~1_combout\ = (!\INST3|sreg0\(2) & (!\INST3|sreg0\(3) & !\INST3|sreg0\(1)))
...
-- Equation(s):
-- \INST8|output~0_combout\ = (!\INST9|current_state.s14~q\ & ((\INST5|sreg\(1)) # (\INST8|sreg~q\)))
...
-- Equation(s):
-- \INST2|clk_reg_extend~0_combout\ = (\INST2|clk_divider:counter[24]~q\ & ((\INST3|sreg3\(2)) # ((\INST3|sreg3\(3)) # (\INST3|sreg3\(1)))))
...
-- Equation(s):
-- \INST2|clk_reg_extend~1_combout\ = (\INST2|clk_reg_extend\(0) & ((\INST3|sreg3\(2)) # ((\INST3|sreg3\(3)) # (\INST3|sreg3\(1)))))
...
-- Equation(s):
-- \INST9|next_state.s1~0_combout\ = (!\INST9|current_state.s0~q\ & ((\INST8|sreg~q\) # (!\INST7|sreg~q\)))
...
-- Equation(s):
-- \INST9|next_state.s2~0_combout\ = (\INST9|current_state.s1~q\ & ((\INST8|sreg~q\) # (!\INST7|sreg~q\)))
...
-- Equation(s):
-- \INST9|current_state~34_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s2~q\)
...
-- Equation(s):
-- \INST9|current_state~37_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s4~q\)
...
-- Equation(s):
-- \INST9|Selector0~0_combout\ = (!\INST9|current_state.s1~q\ & \INST9|current_state.s0~q\)
...
-- Equation(s):
-- \INST9|Selector0~1_combout\ = (\INST9|current_state.s5~q\) # ((!\INST8|sreg~q\ & (\INST7|sreg~q\ & !\INST9|Selector0~0_combout\)))
...
-- Equation(s):
-- \INST7|output~0_combout\ = (!\INST9|current_state.s6~q\ & ((\INST6|sreg\(1)) # (\INST7|sreg~q\)))
...
-- Equation(s):
-- \INST9|current_state~43_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s6~q\)
...
-- Equation(s):
-- \INST9|current_state~42_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s7~q\)
...
-- Equation(s):
-- \INST9|next_state.s9~0_combout\ = (\INST9|current_state.s8~q\ & ((\INST7|sreg~q\) # (!\INST8|sreg~q\)))
...
-- Equation(s):
-- \INST9|next_state.s10~0_combout\ = (\INST9|current_state.s9~q\ & ((\INST7|sreg~q\) # (!\INST8|sreg~q\)))
...
-- Equation(s):
-- \INST9|current_state~38_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s10~q\)
...
-- Equation(s):
-- \INST9|current_state~39_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s11~q\)
...
PORT MAP (
	datac => \INST4|sreg\(1),
	datad => \INST9|current_state.s11~q\,
...
-- Equation(s):
-- \INST9|current_state~40_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s12~q\)
...
PORT MAP (
	datac => \INST4|sreg\(1),
	datad => \INST9|current_state.s12~q\,
...
-- Equation(s):
-- \INST9|Selector1~0_combout\ = (\INST9|current_state.s13~q\) # ((!\INST9|WideOr7~0_combout\ & (!\INST7|sreg~q\ & \INST8|sreg~q\)))
...
-- Equation(s):
-- \INST9|current_state~44_combout\ = (!\INST4|sreg\(1) & \INST9|current_state.s14~q\)
...
-- Equation(s):
-- \INST9|WideOr2~1_combout\ = (!\INST9|current_state.s7~q\ & !\INST9|current_state.s6~q\)
...
-- Equation(s):
-- \INST10|DOUT_TEMP[6]~0_combout\ = (\INST10|clk_proc:COUNT[10]~q\ & (((!\INST9|WideOr2~1_combout\)))) # (!\INST10|clk_proc:COUNT[10]~q\ & ((\INST9|current_state.s15~q\) # ((\INST9|current_state.s14~q\))))
...
-- Equation(s):
-- \INST9|WideOr3~combout\ = (\INST9|current_state.s3~q\) # ((\INST9|current_state.s5~q\) # ((\INST9|current_state.s4~q\) # (\INST9|current_state.s2~q\)))
...
-- Equation(s):
-- \INST9|WideOr6~0_combout\ = (\INST9|current_state.s12~q\) # ((\INST9|current_state.s11~q\) # ((\INST9|current_state.s13~q\) # (\INST9|current_state.s10~q\)))
...
-- Equation(s):
-- \INST9|WideOr8~0_combout\ = (!\INST9|current_state.s4~q\ & (!\INST9|current_state.s8~q\ & (!\INST9|current_state.s12~q\ & \INST9|current_state.s0~q\)))
...
-- Equation(s):
-- \INST9|WideOr9~0_combout\ = (\INST9|current_state.s6~q\) # ((\INST9|current_state.s14~q\) # ((\INST9|current_state.s10~q\) # (\INST9|current_state.s2~q\)))
...
PORT MAP (
	...
	datac => \INST9|current_state.s10~q\,
	datad => \INST9|current_state.s2~q\,
...
-- Equation(s):
-- \INST9|WideOr8~1_combout\ = (\INST9|current_state.s13~q\) # ((\INST9|current_state.s5~q\) # ((\INST9|current_state.s1~q\) # (\INST9|current_state.s9~q\)))
...
-- Equation(s):
-- \INST9|WideOr2~0_combout\ = (!\INST9|current_state.s3~q\ & (\INST9|current_state.s0~q\ & (!\INST9|current_state.s1~q\ & !\INST9|current_state.s2~q\)))
...
-- Equation(s):
-- \INST9|WideOr2~combout\ = (\INST9|current_state.s4~q\) # ((\INST9|current_state.s5~q\) # ((!\INST9|WideOr2~0_combout\) # (!\INST9|WideOr2~1_combout\)))
...
-- Equation(s):
-- \INST2|blink_sig~0_combout\ = (\INST2|clk_divider:counter[22]~q\ & ((\INST3|sreg3\(2)) # ((\INST3|sreg3\(3)) # (\INST3|sreg3\(1)))))
...
-- Equation(s):
-- \INST10|DOUT[3]~1_combout\ = (\INST2|blink_sig~q\ & ((\INST10|clk_proc:COUNT[10]~q\ & (!\INST9|Selector0~0_combout\)) # (!\INST10|clk_proc:COUNT[10]~q\ & ((!\INST9|WideOr7~0_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST9|Selector0~0_combout\,
	datab => \INST9|WideOr7~0_combout\,
...
-- Equation(s):
-- \INST10|DOUT[3]~2_combout\ = (\INST10|DOUT[3]~1_combout\) # ((\INST10|clk_proc:COUNT[10]~q\ & (\INST9|WideOr3~combout\)) # (!\INST10|clk_proc:COUNT[10]~q\ & ((\INST9|WideOr6~0_combout\))))
